...
public struct MainView: View {
    ...
    private var viewModel: StateObject<CurrentWeatherViewModel>
    
    public init(viewModel: StateObject<CurrentWeatherViewModel>) {
                    ...
                    ScrollView(showsIndicators: false) {
                        VStack {
                            ...
                            case .success(let currentWeather):
                                WeatherView(currentWeather: currentWeather, viewModel: viewModel.wrappedValue)
...
struct MainView_Previews: PreviewProvider {
    static var previews: some View {
        MainView(viewModel: StateObject<CurrentWeatherViewModel>.init(wrappedValue: CurrentWeatherViewModel.init(weatherService: WeatherService.init(networkService: DefaultNetworkManager(), locationService: CoreLocationManager()))))
    }
}
